...
## Script to compute basic properties of eQTL SNPs.
...
outfile="eqtl_props/eqtl.basic_props"
...
d_eqtl_annots_norm=left_join(d_eqtl,d_all_norm,by="SNP")

#

d_test_glm=d_eqtl_annots_norm[complete.cases(d_eqtl_annots_norm),] # eQTL SNPs
d1=d_test_glm %>% select(-Tissue,-GeneSymbol,-Pval)
d1$type=1
