...
eqtlfile="eqtl.TSS_props"
bootfile="eqtl_boot.TSS_props" # same as "eqtlfile", but computed and concatenated 1000 times for 1000 bootstrapped samples
eqtlfile_match="eqtl_matched.TSS_props" # same as "eqtlfile", but computed and concatenated 1000 times for 1000 instances of matched SNPs
