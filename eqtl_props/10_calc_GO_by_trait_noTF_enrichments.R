...
## Script to compare GO enrichments (excluding TF genes) for each tissue and matched SNPs
...
eqtlfile="eqtl.GO_props_noTF.by_tissue"
eqtlfile_match="eqtl_matched.GO_props_noTF.by_tissue" # same as "eqtlfile", but computed and concatenated 1000 times for 1000 instances of matched SNPs
