...
gwasfile="supp_note_data/eqtl_catalogue/exon_eqtls.clumped.txt" #data on Zenodo
infofile="snp_annotations/filter_snps_set2.txt" #data on Zenodo
...
d_gwas=d_gwas %>% select(-molecular_trait_id)
...
outfile="extended_eqtl_analyses/eqtlcatalouge/exon_eqtls.GTEx.regression_results.txt"
