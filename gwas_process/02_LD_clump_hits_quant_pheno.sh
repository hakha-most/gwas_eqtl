### Script to LD clump GWAS hits for quantitative traits (rank-normalized, both sexes)
...
infile=$outdir/$pheno"_irnt.hits.txt"
...
#LD clumping
gwasfile=$outdir/$pheno"_irnt.hits.txt"
for chr in {1..22}
do
...
outfile=$clumpdir/$pheno"_irnt.hits.txt"
rm $outfile
