...
gwasfile="gwas_props/gwas.basic_props.by_trait"
gwasfile_match="gwas_props/gwas_matched.basic_props.by_trait" # same as "gwasfile", but computed and concatenated 1000 times for 1000 instances of matched SNPs
