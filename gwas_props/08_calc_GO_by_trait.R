...
## Script to compute GO enrichments of GWAS SNPs for each trait separately
...
GO_file="gene_annotations/12_GO_annotations/genes_BP_min400.txt"
outfile="gwas_props/gwas.GO_props.by_trait"
