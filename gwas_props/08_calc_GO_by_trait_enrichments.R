...
gwasfile="gwas.GO_props.by_trait"
gwasfile_match="gwas_matched.GO_props.by_trait" # same as "gwasfile", but computed and concatenated 1000 times for 1000 instances of matched SNPs
